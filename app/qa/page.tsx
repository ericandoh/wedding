        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h2 className="font-great-vibes text-3xl font-bold text-gray-800 text-center">
                Wedding Details
              </h2>
              
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="font-satisfy text-xl font-semibold text-gray-800 mb-2">
                    When and where is the wedding?
                  </h3>
                  <p className="font-satisfy text-gray-700">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-6 rounded-lg text-center">
                <p className="font-satisfy text-lg text-gray-700 mb-4">
                  If you have any other questions or concerns, please don't hesitate to reach out to us!
                </p>
                <p className="font-satisfy text-base text-gray-600">
